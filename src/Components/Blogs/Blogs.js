...
const Blogs = () => {
    return (
        <div className="container mb-5">
            ...
            <div className="grid md:grid-cols-2 mt-3 gap-3 sm:grid-cols-1">
            ...
            <button className="mx-auto block border py-2 px-4 bg-green-400 rounded text-white">See All Blogs</button>
        </div>
    );
};
